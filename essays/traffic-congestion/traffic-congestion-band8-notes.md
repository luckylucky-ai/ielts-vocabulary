...
task: task2
task_type: Discussion + Opinion
group: city
title: Traffic Congestion
title_cn: 交通拥堵
cards:
  - traffic-congestion-card-01-cover.png
  - traffic-congestion-card-02-sample.png
  - traffic-congestion-card-03-structure.png
  - traffic-congestion-card-04-phrases.png
  - traffic-congestion-card-05-ideas.png
---
...
| 维度 | 这篇的体现 |
|---|---|
| Task Response 任务回应 | 讨论"公交 vs 修路"双方并明确表态"两者结合"；每段先让步（However 承认对方合理）再反驳，紧扣题目 |
| Coherence & Cohesion 连贯衔接 | in turn / However / On the other hand / Rather than / In conclusion 串起逻辑，每段主题句清晰 |
| Lexical Resource 词汇 | induced demand、strategic road expansion、easing bottlenecks 等学术搭配；address / tackle / solve / alleviate 同义替换避免重复 |
| Grammatical Range 语法 | 定语从句（the phenomenon whereby…）、让步状语、被动语态（are offered）、比较结构，句式多样准确 |
...
![Cover](traffic-congestion-card-01-cover.png)

![Sample Essay](traffic-congestion-card-02-sample.png)

![Structure](traffic-congestion-card-03-structure.png)

![Phrases](traffic-congestion-card-04-phrases.png)

![Idea Bank](traffic-congestion-card-05-ideas.png)
